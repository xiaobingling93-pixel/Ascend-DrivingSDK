...
#include "select_idx_with_mask/op_host/select_idx_with_mask_tiling.h"
...
public:
    explicit SelectIdxWithMask(const char* name) : OpDef(name)
    {
        ...
        this->Output("out_min_idx")
            ...
            .UnknownShapeFormat({ge::FORMAT_ND})
            .AutoContiguous();
        this->SetInferShape(ge::InferShapeForSelectIdxWithMask).SetInferDataType(ge::InferDataTypeForSelectIdxWithMask);
